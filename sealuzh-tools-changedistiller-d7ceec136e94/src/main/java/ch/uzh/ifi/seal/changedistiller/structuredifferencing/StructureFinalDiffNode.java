 ...
 */
public interface StructureFinalDiffNode {
     ...
     */
    List<? extends StructureFinalDiffNode> getChildren();
    
    void setfChildren(List<StructureDiffNode> list);
     ...
     * 
     * @return the compilation unit of the node
     */
    String getName();
     ...
     */
    boolean isOfSameTypeAs(StructureFinalDiffNode other);
