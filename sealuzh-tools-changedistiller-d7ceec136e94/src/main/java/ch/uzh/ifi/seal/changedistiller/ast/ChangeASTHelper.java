 ...
 */
public interface ChangeASTHelper<T extends StructureFinalDiffNode> {
     ...
     */
    Node createDeclarationChangeTree(T node);
     ...
     */
    Node createMethodBodyChangeTree(T node);
     ...
     */
    SourceCodeEntity createChangeEntity(T node);
     ...
     */
    StructureEntityVersion createStructureEntityChangeVersion(T node, String version);
    /**
     * Creates and returns the {@link StructureEntityVersion} for the {@link StructureNode}.
     * 
     * @param node
     ...
     * @return the structure entity version for the node
     */
    StructureEntityVersion createStructureEntityChangeVersion(T node);
     ...
     */
    StructureEntityVersion createMethodInClassChangeHistory(ClassHistory classHistory, T node, String version);
     ...
     * @return the method structure entity version in the class history for the node
     */
    StructureEntityVersion createMethodInClassChangeHistory(ClassHistory classHistory, T node);
     ...
     */
    StructureEntityVersion createFieldInClassChangeHistory(ClassHistory classHistory, T node, String version);
     ...
     * @return the field structure entity version in the class history for the node
     */
    StructureEntityVersion createFieldInClassChangeHistory(ClassHistory classHistory, T node);
     ...
     */
    StructureEntityVersion createInnerClassInClassChangeHistory(ClassHistory classHistory, T node, String version);
     ...
     * @return the class structure entity version in the class history for the node
     */
    StructureEntityVersion createInnerClassInClassChangeHistory(ClassHistory classHistory, T node);
     ...
     * @return the declaration tree for the structure node
     */
    Node createDeclarationChangeTree(T node, String qualifiedName);

    CompilationUnit returnCU();

	JavaStructureChangeNode createMyTree();

	List<Comment> getComments();

	Node createDeclarationChangeTree(JavaStructureChangeNode node, String qualifiedName);

	JavaStructureChangeNode createStructureTree();
